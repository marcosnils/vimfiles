...
vim.keymap.set('n', "<leader>lS", function() builtin.lsp_dynamic_workspace_symbols(theme) end, bufopts)
vim.keymap.set('n', '<space>D', function() builtin.lsp_type_definitions(theme) end, bufopts)
vim.keymap.set('n', 'gi', function() builtin.lsp_implementations(theme) end, bufopts)
--
